        ...
        <div className="container">
          ...
          <section className="cta" aria-label="Call to action">
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: 12 }}>
                <a href="https://github.com/Jyothireddy-pula/RecruitIQ" target="_blank" rel="noopener noreferrer">
      ...
      <footer className="ah-footer" role="contentinfo">
        <div className="container">
          <div className="footer-content">
            <div className="logo">RecruitIQ</div>
            <div className="footer-links">
              <a href="https://github.com/Jyothireddy-pula/RecruitIQ">Github</a>
            </div>
          </div>
        </div>
      </footer>
